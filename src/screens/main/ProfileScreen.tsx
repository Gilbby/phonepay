      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingsCard}>
            ...
            <SettingItem icon="card-outline" label="Payment Methods" onPress={() => {}} />
            <View style={styles.settingDivider} />
            <SettingItem icon="document-text-outline" label="Transaction Limits" value="K10,000/day" onPress={() => {}} />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingsCard}>
            ...
            <View style={styles.settingDivider} />
            <SettingItem icon="key-outline" label="Login Activity" onPress={() => {}} />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingsCard}>
            <SettingToggle icon="notifications-outline" label="Push Notifications" value={notificationsEnabled} onValueChange={setNotificationsEnabled} />
            <View style={styles.settingDivider} />
            <SettingItem icon="language-outline" label="Language" value="English" onPress={() => {}} />
            <View style={styles.settingDivider} />
            <SettingItem icon="moon-outline" label="Appearance" value="Light" onPress={() => {}} />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingsCard}>
            ...
            <View style={styles.settingDivider} />
            <SettingItem icon="chatbubble-outline" label="Contact Support" onPress={() => {}} />
            <View style={styles.settingDivider} />
            <SettingItem icon="document-outline" label="Terms of Service" onPress={() => {}} />
            <View style={styles.settingDivider} />
        ...
        <View style={styles.section}>
          <View style={styles.settingsCard}>
            <SettingItem icon="log-out-outline" label="Logout" onPress={handleLogout} showChevron={false} danger />
          </View>
        </View>
